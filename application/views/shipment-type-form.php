<div class="row">
  <div class="col-md-12">
    ...
    <form class="" action="<?php echo base_url();?>settings/shipmenttypes" method="post">
      <div class="form-group">
        <div class="col-md-12">
          <label for="">Enter New Shipping Status</label>
        </div>
        <div class="col-md-6">
        <input type="search" name="type" value="" class="form-control" required>
      </div>
      <div class="col-md-6">
